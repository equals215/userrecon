...
check1=$(curl -s -i "https://www.pinterest.com/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' | grep -o 'HTTP/2 404' ; echo $?)
...
check1=$(curl -s -i "api.tumblr.com/v2/blog/$username/avatar" | grep -o '404 Not Found' ; echo $?)
...
check1=$(curl -s -i "https://www.flickr.com/people/$username" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:32.0) Gecko/20010801"' | grep -o 'It appears the profile you seek doesn’t exist.' ; echo $?)
...
check1=$(curl -s -i "https://open.spotify.com/user/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/1.1 404 Not Found' ; echo $?)
...
check1=$(curl -s -i "https://www.instructables.com/member/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/1.1 404 Not Found' ; echo $?)
...
check1=$(curl -s -i "https://keybase.io/$username" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404' ; echo $?)
